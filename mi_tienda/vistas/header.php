...
<head>
  ...
  <title>Interjet Networks </title>
  <link rel="icon" type="image/png" href="../public/img/LogoInt.jpg" />
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>Interjet</b> Networks</span>
    </a>
...
if ($_SESSION['ubicacion']==1) {
  echo '<li class="treeview">
          <a href="#">
            <i class="fa  fa-dashboard (alias)"></i> <span>Ubicación</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="Localizacion.php"><i class="fa fa-circle-o"></i> Ubicacion</a></li>
